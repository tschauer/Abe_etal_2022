...
matrix_files <- c(matrix_files, gsub("/matrix/","/matrix_ave/",gsub(my_assay,"IgG",gsub("_DRB|_[1-3]", "", matrix_files))))
...
for(i in seq_along(my_mats)){
    ...
    my_mat_IgG <- get(gsub(my_assay,"IgG",gsub("_DRB|_[1-3]", "", my_mats[i])))
