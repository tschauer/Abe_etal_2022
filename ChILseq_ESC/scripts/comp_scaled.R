...
stopifnot(length(matrix_files) == 12)
...
SampleMatchTable <- data.frame(Stages = c("ChIL100C", "ChIL1000C",  "ChIP"),
...
SampleMatchTable$Dark <- sapply(SampleMatchTable$Colors, function(x){colorRampPalette(c("white",x,"black"))(21)[c(5,10,15)]})
...
my_plot_mats <- list(c("GB.ChIL100C_S5P_A.Q5","GB.ChIL1000C_S5P_A.Q5","GB.ChIP_S5P_A.Q5"),
                     c("GB.ChIL100C_S2P_A.Q5","GB.ChIL1000C_S2P_A.Q5","GB.ChIP_S2P_A.Q5"))
...
for(my_scaling in c("scaled","unscaled")){
        ...
        pdf(file = gsub("2.pdf","1.pdf", gsub("scaled",my_scaling,output_file)), width = 6.5, height = 4.5)
        ...
        for(my_sample_mats in my_plot_mats){
                ...
                plotComposite(my_sample_mats = my_sample_mats, 
                              ...
                              ylims = c(0, ifelse(my_scaling == "scaled", 1, 1.0)),
                              my_binning = 1,
...
my_plot_mats <- list(c("GB.ChIL100C_S5P_A.Q5","GB.ChIL100C_S2P_A.Q5"),
                     c("GB.ChIL1000C_S5P_A.Q5","GB.ChIL1000C_S2P_A.Q5"),
                     c("GB.ChIP_S5P_A.Q5","GB.ChIP_S2P_A.Q5"))
